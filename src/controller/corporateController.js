...
const corporate = async (req,res)=>{
    res.setHeader("Access-Control-Allow-Origin", "*");
      try {
          ...
          data.date = dates;
          data.time = times;
          let savedata = await corporateModel.create(data);
  ...
  //===============================================================================
  let getCorporate = async (req,res)=>{
    res.setHeader("Access-Control-Allow-Origin", "*");
    try {
  ...
  //============================================================================
  const dupeCorporate =async (req,res)=>{
    res.setHeader("Access-Control-Allow-Origin", "*");
    try {
  ...
  //=========================================================================================
  const corporateRangeData = async (req, res) => {
    res.setHeader("Access-Control-Allow-Origin", "*");
    try {
  ...
  //=======================================================================================
  module.exports ={ corporate , getCorporate ,  dupeCorporate ,  corporateUniqueEntries , corporateRangeData}